...
Validation Logic: An increase in payment failures over time would confirm this hypothesis.

Analytical Approach

The analysis was approached in the same way a business problem is handled in a real-world setting.
